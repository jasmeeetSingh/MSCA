...
datapath <- 'C:\\Users\\jasme\\Downloads\\UChicago\\Quarter2\\Linear Non-Linear\\Week1\\nonlinear_models_01_data\\'
data <- read.table(paste(datapath,'Week1_Test_Sample.csv',sep = '/'), sep = ',', header=TRUE)
